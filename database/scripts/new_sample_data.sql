...
INSERT INTO comments (post_id, content, created_by, created_at, updated_by, updated_at) VALUES
                                                                    (1, 'Yo recomendaría Next.js para proyectos que necesiten SSR', 2, NOW(), 2, NOW()),
                                                                    (1, 'Vite es excelente para desarrollo, muy rápido', 6, NOW(), 6, NOW()),
                                                                    (2, 'Muy útil, gracias por compartir la configuración', 5, NOW(), 5, NOW()),
                                                                    (2, '¿Has probado con Kubernetes en lugar de Docker Compose?', 7, NOW(), 7, NOW()),
                                                                    (3, 'Excelente guía, muy clara para principiantes', 8, NOW(), 8, NOW()),
                                                                    (3, '¿Podrías agregar ejemplos de redes neuronales?', 1, NOW(), 1, NOW()),
                                                                    (4, 'React Native tiene mejor ecosistema, pero Flutter es más consistente', 5, NOW(), 5, NOW()),
                                                                    (4, 'Flutter tiene mejor rendimiento nativo', 7, NOW(), 7, NOW()),
                                                                    (5, 'Go es perfecto para microservicios, muy eficiente', 3, NOW(), 3, NOW()),
                                                                    (5, '¿Usas algún ORM específico con Go?', 8, NOW(), 8, NOW()),
                                                                    (6, 'React.memo es clave para optimización', 1, NOW(), 1, NOW()),
                                                                    (6, 'También recomiendo usar React DevTools Profiler', 4, NOW(), 4, NOW());
...
-- =========================
INSERT INTO comments (post_id, content, created_by, created_at, updated_by, updated_at) VALUES
                                                                    (1, 'Para empezar recomiendo Canon EOS Rebel', 2, NOW(), 2, NOW()),
                                                                    (1, 'Nikon D3500 también es una gran opción económica', 4, NOW(), 4, NOW()),
                                                                    (1, 'Sony A6000 es una opción económica', 6, NOW(), 6, NOW()),
                                                                    (2, 'Los presets de Lightroom ahorran mucho tiempo', 3, NOW(), 3, NOW()),
                                                                    (2, '¡Los atajos de teclado salvan horas!', 3, NOW(), 3, NOW()),
                                                                    (3, 'Gracias por la rutina, la probaré esta semana', 5, NOW(), 5, NOW()),
                                                                    (3, '¿Con qué frecuencia recomiendas aumentar el peso?', 9, NOW(), 9, NOW()),
                                                                    (4, 'El salmón es excelente para ganar masa muscular', 7, NOW(), 7, NOW()),
                                                                    (4, 'No olviden los carbohidratos complejos', 2, NOW(), 2, NOW()),
                                                                    (3, 'Rutina sencilla y efectiva, gracias', 5, NOW(), 5, NOW()),
                                                                    (3, '¿Cuántas series recomiendas por ejercicio?', 7, NOW(), 7, NOW()),
                                                                    (4, 'El arroz con pollo es clave en volumen', 9, NOW(), 9, NOW()),
                                                                    (4, 'Las legumbres no pueden faltar', 11, NOW(), 11, NOW()),
                                                                    (5, 'Mi top incluye Interestelar y Blade Runner', 4, NOW(), 4, NOW()),
                                                                    (5, '¿Alguien vio Dune 2? Brutal', 11, NOW(), 11, NOW()),
                                                                    (6, 'Chernobyl es la mejor miniserie que vi', 13, NOW(), 13, NOW()),
                                                                    (6, 'También recomiendo The Night Of', 14, NOW(), 14, NOW()),
                                                                    (7, 'Emprender solo es más arriesgado', 12, NOW(), 12, NOW()),
                                                                    (7, 'Depende de tu tolerancia al riesgo', 8, NOW(), 8, NOW()),
                                                                    (8, 'Notion y Trello me salvaron la vida', 1, NOW(), 1, NOW()),
                                                                    (9, 'Hablar en voz alta ayuda mucho', 10, NOW(), 10, NOW()),
                                                                    (10, 'WaniKani es excelente para kanjis', 5, NOW(), 5, NOW()),
                                                                    (10, 'Duolingo sirve pero se queda corto', 2, NOW(), 2, NOW()),
                                                                    (11, 'Yo cultivo albahaca en macetas pequeñas', 4, NOW(), 4, NOW()),
                                                                    (12, 'Cambiar botellas plásticas por termo metálico', 6, NOW(), 6, NOW()),
                                                                    (13, 'La meditación me ayudó bastante', 7, NOW(), 7, NOW()),
                                                                    (14, 'Recomiendo “El cerebro y la inteligencia emocional”', 9, NOW(), 9, NOW()),
                                                                    (15, 'Los castillos medievales eran más pequeños de lo que pensamos', 11, NOW(), 11, NOW()),
                                                                    (16, 'Aceleró la urbanización, pero explotó a los trabajadores', 2, NOW(), 2, NOW()),
                                                                    (17, '¡Yo viajo a México para verlo!', 14, NOW(), 14, NOW()),
                                                                    (18, 'SkyWatcher 130 es muy bueno calidad/precio', 3, NOW(), 3, NOW()),
                                                                    (19, 'El libre albedrío es una ilusión', 10, NOW(), 10, NOW()),
                                                                    (19, 'No estoy de acuerdo, siempre tenemos elección', 13, NOW(), 13, NOW()),
                                                                    (20, 'Marco Aurelio es una gran referencia', 12, NOW(), 12, NOW()),
                                                                    (21, 'It Takes Two es imperdible', 9, NOW(), 9, NOW()),
                                                                    (21, 'También recomiendo Deep Rock Galactic', 11, NOW(), 11, NOW()),
                                                                    (22, 'Yo la compré y no me arrepiento', 6, NOW(), 6, NOW()),
                                                                    (22, 'Mejor esperar una revisión Slim', 4, NOW(), 4, NOW());
...
-- =========================
INSERT INTO comments (post_id, content, created_by, created_at, updated_by, updated_at) VALUES
                                                                    (23, 'Un trípode ayuda muchísimo en nocturnas', 7, NOW(), 7, NOW()),
                                                                    (23, 'También usar ISO bajo y exposición larga', 9, NOW(), 9, NOW()),
                                                                    (24, 'RAW da más control, pero pesa mucho', 3, NOW(), 3, NOW()),
                                                                    (24, 'JPG es suficiente para redes sociales', 13, NOW(), 13, NOW()),
                                                                    (25, 'El cardio en ayunas no es mágico, solo un método más', 8, NOW(), 8, NOW()),
                                                                    (25, 'Yo lo probé y me ayudó a bajar grasa', 12, NOW(), 12, NOW()),
                                                                    (26, 'La creatina es lo más respaldado por estudios', 1, NOW(), 1, NOW()),
                                                                    (26, 'Proteína en polvo solo si no llegas con comida real', 14, NOW(), 14, NOW()),
                                                                    (27, 'Inception me voló la cabeza', 4, NOW(), 4, NOW()),
                                                                    (27, 'Interstellar tiene mejor banda sonora', 11, NOW(), 11, NOW()),
                                                                    (28, 'Dark es de lo mejor que vi en Netflix', 10, NOW(), 10, NOW()),
                                                                    (28, 'The OA está muy infravalorada', 2, NOW(), 2, NOW()),
                                                                    (29, 'Un pitch claro y breve es clave', 6, NOW(), 6, NOW()),
                                                                    (29, 'Conseguir tracción antes ayuda mucho', 7, NOW(), 7, NOW()),
                                                                    (30, 'Fracasar enseña más que el éxito', 9, NOW(), 9, NOW()),
                                                                    (30, 'Totalmente, cada error es aprendizaje', 5, NOW(), 5, NOW()),
                                                                    (31, 'Un profe corrige errores que una app no', 11, NOW(), 11, NOW()),
                                                                    (31, 'Depende del presupuesto y disciplina', 3, NOW(), 3, NOW()),
                                                                    (32, 'Coffee Break French es muy bueno', 12, NOW(), 12, NOW()),
                                                                    (32, 'También InnerFrench', 14, NOW(), 14, NOW()),
                                                                    (33, '¿Cuánto tardaste en recuperar la inversión?', 8, NOW(), 8, NOW()),
                                                                    (33, 'Quiero poner paneles pero me da miedo el costo', 2, NOW(), 2, NOW()),
                                                                    (34, 'La minería de litio es un gran problema', 4, NOW(), 4, NOW()),
                                                                    (34, 'El balance aún no es tan verde como parece', 10, NOW(), 10, NOW()),
                                                                    (35, 'Mindfulness me ayudó a dormir mejor', 7, NOW(), 7, NOW()),
                                                                    (36, 'Lo más importante es escuchar sin juzgar', 13, NOW(), 13, NOW()),
                                                                    (36, 'A veces solo acompañar ya es suficiente', 9, NOW(), 9, NOW()),
                                                                    (37, 'El derecho romano está en nuestras leyes civiles', 1, NOW(), 1, NOW()),
                                                                    (38, 'Recomiendo “El Tercer Reich” de Shirer', 6, NOW(), 6, NOW()),
                                                                    (38, 'También “La Segunda Guerra Mundial” de Keegan', 4, NOW(), 4, NOW()),
                                                                    (39, 'Europa es candidata para albergar vida', 12, NOW(), 12, NOW()),
                                                                    (39, 'Ganímedes es enorme, casi un planeta', 5, NOW(), 5, NOW()),
                                                                    (40, 'La paradoja es fascinante, tal vez seamos los primeros', 8, NOW(), 8, NOW()),
                                                                    (41, 'Nietzsche inspira pero también se malinterpreta mucho', 4, NOW(), 4, NOW()),
                                                                    (42, 'La IA debe usarse con responsabilidad', 2, NOW(), 2, NOW()),
                                                                    (42, 'El problema es que la ética avanza más lento que la tecnología', 10, NOW(), 10, NOW()),
                                                                    (43, 'The Witcher 3 está en mi top', 9, NOW(), 9, NOW()),
                                                                    (43, 'Persona 5 es otra joya', 13, NOW(), 13, NOW()),
                                                                    (44, 'Xbox Cloud tiene mejor estabilidad', 14, NOW(), 14, NOW()),
                                                                    (44, 'GeForce Now va bien si tienes buena conexión', 11, NOW(), 11, NOW());
...
-- =========================
INSERT INTO comments (post_id, content, created_by, created_at, updated_by, updated_at) VALUES
                                                                    (45, 'La luz natural siempre da un look más suave', 2, NOW(), 2, NOW()),
                                                                    (45, 'Yo prefiero flash para retratos dramáticos', 9, NOW(), 9, NOW()),
                                                                    (46, 'Depende si quieres paisaje o retrato', 3, NOW(), 3, NOW()),
                                                                    (46, 'Un 50mm f1.8 es versátil y barato', 14, NOW(), 14, NOW()),
                                                                    (47, 'HIIT es brutal si tienes poco tiempo', 1, NOW(), 1, NOW()),
                                                                    (47, 'Cuidado con la técnica, evita lesiones', 7, NOW(), 7, NOW()),
                                                                    (48, 'Estirar después es clave', 12, NOW(), 12, NOW()),
                                                                    (48, 'También ayuda hacer foam roller', 5, NOW(), 5, NOW()),
                                                                    (49, 'It sigue siendo mi favorita del año', 6, NOW(), 6, NOW()),
                                                                    (49, 'La bruja de Blair es un clásico eterno', 11, NOW(), 11, NOW()),
                                                                    (50, 'Planet Earth II es imperdible', 8, NOW(), 8, NOW()),
                                                                    (50, 'Recomiendo “The Social Dilemma” para tech lovers', 13, NOW(), 13, NOW()),
                                                                    (51, 'Google Analytics y Mailchimp son útiles', 9, NOW(), 9, NOW()),
                                                                    (51, 'También recomiendo Canva para marketing rápido', 2, NOW(), 2, NOW()),
                                                                    (52, 'Hacer encuestas y prototipos ayuda mucho', 1, NOW(), 1, NOW()),
                                                                    (52, 'Nunca subestimes el feedback de usuarios reales', 12, NOW(), 12, NOW()),
                                                                    (53, 'HelloTalk es muy bueno para practicar idiomas', 7, NOW(), 7, NOW()),
                                                                    (53, 'Tandem también es útil', 6, NOW(), 6, NOW()),
                                                                    (54, 'Los errores con “their/there/they’re” son comunes', 14, NOW(), 14, NOW()),
                                                                    (54, 'No olvidar el uso de tiempos verbales', 3, NOW(), 3, NOW()),
                                                                    (55, 'Bicicleta siempre que puedas', 8, NOW(), 8, NOW()),
                                                                    (55, 'El auto eléctrico reduce emisiones pero no todo es verde', 5, NOW(), 5, NOW()),
                                                                    (56, 'Llevar baterías viejas a puntos limpios', 9, NOW(), 9, NOW()),
                                                                    (56, 'No botar celulares a la basura', 4, NOW(), 4, NOW()),
                                                                    (57, 'Ejercicios de memoria con cartas funcionan', 10, NOW(), 10, NOW()),
                                                                    (57, 'Repetir nombres y listas ayuda mucho', 1, NOW(), 1, NOW()),
                                                                    (58, 'Respirar profundo antes de empezar', 12, NOW(), 12, NOW()),
                                                                    (58, 'Organizar tareas y pausas también ayuda', 2, NOW(), 2, NOW()),
                                                                    (59, 'La arquitectura otomana es impresionante', 6, NOW(), 6, NOW()),
                                                                    (59, 'Sus bazares eran únicos', 11, NOW(), 11, NOW()),
                                                                    (60, 'Ambas revoluciones cambiaron el mundo', 14, NOW(), 14, NOW()),
                                                                    (60, 'La revolución francesa fue más radical', 3, NOW(), 3, NOW()),
                                                                    (61, 'Halley aparece cada 76 años', 7, NOW(), 7, NOW()),
                                                                    (61, 'Hale-Bopp dejó un espectáculo inolvidable', 10, NOW(), 10, NOW()),
                                                                    (62, 'Orión es fácil de encontrar', 2, NOW(), 2, NOW()),
                                                                    (62, 'También busca Casiopea en el cielo norte', 12, NOW(), 12, NOW()),
                                                                    (63, 'Camus y Sartre son imperdibles', 5, NOW(), 5, NOW()),
                                                                    (63, '“El extranjero” es excelente para empezar', 8, NOW(), 8, NOW()),
                                                                    (64, 'La ética ambiental debe ser prioritaria', 6, NOW(), 6, NOW()),
                                                                    (64, 'Todos podemos hacer cambios pequeños diarios', 9, NOW(), 9, NOW()),
                                                                    (65, 'Hollow Knight es un juego indie genial', 1, NOW(), 1, NOW()),
                                                                    (66, 'Una GTX 1650 sirve para empezar', 4, NOW(), 4, NOW()),
                                                                    (67, 'OBS Studio es gratis y potente', 11, NOW(), 11, NOW()),
                                                                    (67, 'Recomiendo aprender a usar overlays', 13, NOW(), 13, NOW());
...
-- =========================
INSERT INTO comments (post_id, content, created_by, created_at, updated_by, updated_at) VALUES
(71, 'Me gusta capturar escenas con un 35mm fijo', 2, NOW(), 2, NOW()),
(71, 'La clave es pasar desapercibido', 6, NOW(), 6, NOW()),
(72, 'Golden hour siempre da tonos cálidos hermosos', 5, NOW(), 5, NOW()),
(72, 'Prefiero blue hour para paisajes urbanos', 13, NOW(), 13, NOW()),
(73, 'Las bandas son muy útiles en viajes', 7, NOW(), 7, NOW()),
(73, 'Perfectas para entrenar en casa', 11, NOW(), 11, NOW()),
(74, 'No calentar es el peor error', 8, NOW(), 8, NOW()),
(74, 'Hacer siempre ego lifting retrasa el progreso', 1, NOW(), 1, NOW()),
(75, 'Persepolis es una joya animada', 3, NOW(), 3, NOW()),
(75, 'Me encantó “Anomalisa”', 9, NOW(), 9, NOW()),
(76, 'Dark tiene un soundtrack increíble', 4, NOW(), 4, NOW()),
(76, 'Arcane también destaca por la música', 10, NOW(), 10, NOW()),
(77, 'Usar pocas diapositivas y al grano', 12, NOW(), 12, NOW()),
(77, 'Las métricas son lo más importante', 14, NOW(), 14, NOW()),
(78, 'Notion y Toggl ayudan mucho', 6, NOW(), 6, NOW()),
(78, 'La disciplina es más importante que la app', 2, NOW(), 2, NOW()),
(79, 'Hacer flashcards funciona excelente', 8, NOW(), 8, NOW()),
(79, 'Yo uso la técnica de repetición espaciada', 5, NOW(), 5, NOW()),
(80, 'Los libros de Penguin Readers son buenos', 7, NOW(), 7, NOW()),
(80, 'También recomiendo leer Harry Potter en inglés', 13, NOW(), 13, NOW()),
(81, 'El compostaje reduce mucho la basura', 4, NOW(), 4, NOW()),
(81, 'Al principio huele raro, luego mejora', 11, NOW(), 11, NOW()),
(82, 'El costo inicial es alto aún', 9, NOW(), 9, NOW()),
(82, 'Más viable en zonas con viento constante', 3, NOW(), 3, NOW()),
(83, 'Dormir poco afecta el humor', 10, NOW(), 10, NOW()),
(83, 'La higiene del sueño es clave', 1, NOW(), 1, NOW()),
(84, 'La técnica Pomodoro me ayuda', 6, NOW(), 6, NOW()),
(84, 'Bloquear distracciones con apps es útil', 2, NOW(), 2, NOW()),
(85, 'La corrupción también debilitó a Roma', 12, NOW(), 12, NOW()),
(85, 'El imperio se fragmentó demasiado', 14, NOW(), 14, NOW()),
(86, 'La rueda cambió todo', 8, NOW(), 8, NOW()),
(86, 'Internet es el invento más influyente', 5, NOW(), 5, NOW()),
(87, 'Los agujeros negros generan fascinación', 7, NOW(), 7, NOW()),
(87, 'Me interesa la foto de M87', 13, NOW(), 13, NOW()),
(88, 'SpaceX lidera la carrera', 9, NOW(), 9, NOW()),
(88, 'Blue Origin va más lento pero seguro', 4, NOW(), 4, NOW()),
(89, 'La caverna es una metáfora potente', 3, NOW(), 3, NOW()),
(89, 'Sigue vigente en redes sociales', 11, NOW(), 11, NOW()),
(90, 'La felicidad está en el equilibrio', 1, NOW(), 1, NOW()),
(90, 'La virtud es esencial según Aristóteles', 6, NOW(), 6, NOW()),
(91, 'Valorant tiene mejor ritmo', 12, NOW(), 12, NOW()),
(91, 'CS:GO es el clásico indiscutible', 8, NOW(), 8, NOW()),
(92, 'Los móviles ya son consolas portátiles', 14, NOW(), 14, NOW()),
(92, 'El futuro es crossplay total', 10, NOW(), 10, NOW()),
(93, '“El viejo y el mar” es imperdible', 7, NOW(), 7, NOW()),
(93, 'Las novelas de Murakami también son buenas', 5, NOW(), 5, NOW()),
(94, 'Cortázar siempre sorprende', 13, NOW(), 13, NOW()),
(94, 'Borges es lectura obligada', 1, NOW(), 1, NOW()),
(95, 'Armar un plan de estudio ayuda mucho', 9, NOW(), 9, NOW()),
(95, 'No dejar todo para el último día', 6, NOW(), 6, NOW()),
(96, 'El libro de Abelson & Sussman es muy bueno', 2, NOW(), 2, NOW()),
(96, 'También recomiendo Code Complete', 12, NOW(), 12, NOW()),
(97, 'Kubernetes tiene más comunidad', 11, NOW(), 11, NOW()),
(97, 'Swarm es más simple de usar', 3, NOW(), 3, NOW()),
(98, 'Me encanta la nueva sintaxis de patrones', 8, NOW(), 8, NOW()),
(98, 'Python 3.12 mejoró el rendimiento', 14, NOW(), 14, NOW()),
(99, 'Dark Side of the Moon es un clásico', 10, NOW(), 10, NOW()),
(99, 'Abbey Road cambió la música', 4, NOW(), 4, NOW()),
(100, 'Los auriculares JBL son buena opción', 9, NOW(), 9, NOW()),
(100, 'Los Sony WH-1000XM5 son excelentes', 13, NOW(), 13, NOW());